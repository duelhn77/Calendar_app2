...
"[project]/.next-internal/server/app/api/fetchEngagements/route/actions.js [app-rsc] (server actions loader, ecmascript)": (function(__turbopack_context__) {
...
"[project]/src/app/api/fetchEngagements/route.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
const runtime = "nodejs"; // ✅ APIルートのランタイムをNode.jsに設定
async function GET() {
    try {
        // ✅ 環境変数の確認
        ...
        const response = await sheets.spreadsheets.values.get({
            ...
            range: 'Engagements!A2:A'
        });
        const engagements = (response.data.values || []).map((row)=>({
                name: row[0]
            }));
        console.log("✅ 取得したエンゲージメント:", engagements);
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(engagements, {
            status: 200
        });
    } catch (error) {
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__5650da3d._.js.map